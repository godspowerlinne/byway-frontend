...
const Login = () => {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-[45%,55%] pt-16 sm:pt-16 max-w-screen-2xl mx-auto items-center lg:pr-16 bg-gradient-to-br from-white to-gray-100 dark:from-[#0f172a] dark:to-[#020617] transition-colors duration-300'>
