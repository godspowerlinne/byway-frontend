    ...
    const HeroText = () => {
        return (
            <div className="max-w-[590px] flex flex-col gap-4">
                <h1 className="text-[40px] font-bold capitalize leading-tight text-[#1E293B] dark:text-[#F1F5F9]">
                ...
                <Button
                    ...
                    BtnStyle="bg-[#3B82F6] dark:bg-[#410B65] text-white w-full lg:w-max justify-center lg:justify-start rounded-md mt-6 hover:bg-blue-700 dark:hover:bg-purple-700"
                />
            </div>
        )
    }
